...
public class ChatroomInfo {
    ...
    /**
     * Get all the messages that have been sent to this chatroom. This includes getting the sender
     * username and the corresponding message for every message.
     *
     * @return a string that contains all the messages sent and their corresponding senders
     */
